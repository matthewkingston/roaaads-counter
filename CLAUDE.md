...
python3 analysis/derive_component_profiles.py              # regenerate hourly_fractions.csv res/commute/retail shape columns from NTS microdata (car-specific joint dow×hour; school columns carried forward; independent of generation_rates.json)
