...
N_WORKERS         = int(os.environ.get("BUILD_PATHS_WORKERS", "4"))  # parallel probit-pass workers;
                             # default 4. Override per-run via BUILD_PATHS_WORKERS (e.g. =1 on a low-core
                             # box; ~100-150 MB/worker, capped at N_PASSES). Output is identical.
